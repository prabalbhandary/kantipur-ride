    ...
    <div className="relative">
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-center p-4 bg-black bg-opacity-50">
        ...
        <div className="flex flex-wrap justify-center gap-8">
          <div className="bg-white bg-opacity-50 p-6 rounded-lg shadow-lg text-center">
            <h1 className="text-4xl font-bold text-blue-600 mb-2">5000</h1>
            <p className="text-gray-700">No of Vehicles</p>
          </div>
          <div className="bg-white bg-opacity-50 p-6 rounded-lg shadow-lg text-center">
            <h1 className="text-4xl font-bold text-blue-600 mb-2">2 Lakh +</h1>
            <p className="text-gray-700">Customers Served Annually</p>
          </div>
          <div className="bg-white bg-opacity-50 p-6 rounded-lg shadow-lg text-center">
            <h1 className="text-4xl font-bold text-blue-600 mb-2">5000 +</h1>
            <p className="text-gray-700">No of Drivers</p>
          </div>
          <div className="bg-white bg-opacity-50 p-6 rounded-lg shadow-lg text-center">
